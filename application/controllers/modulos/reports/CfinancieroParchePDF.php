...
class CfinancieroParchePDF extends REST_Controller
{
    ...
    public function __construct()
    {
        ...
        //!NUEVO MODELO PARA PARCHE PDF- FINANZAS HENERAL 2022
        $this->load->model('estadosf/MpdfEstadosFGparche');
    ...
    // public function GetPdfParche_get()
    // {
    //     $this->load->library('reports/financiero/RptEstadofingen');
        
    //     //!PDF NUEVO - ANDREA 20/ENERO/2022 
    ...
    //     //Insertar el plan
    //     $oplanfactura = new MpdfEstadosFGparche();
    ...
    //     for($i = 1; $i < 6; $i++)
    //     {
    //         $oservicio = new MpdfEstadosFGparche();
    ...
    //     for ($i = 1; $i < 6; $i++)
    //     {
    //         $oestadofinanciero = new MpdfEstadosFGparche();
    ...
    //         {
    //             $odetalleestadofinanciero = new MpdfEstadosFGparche();
    ...
    //     $ocostoga = new MpdfEstadosFGparche();
    //     $ocostoga->Anio = $Anio;
    ...
    //             for ($z = 0; $z < $Mes; $z++)
    //             {
    //                 $oactualcostoga = new MpdfEstadosFGparche();
    ...
    //     //FIN COSTOS GA
    //     $ogastosdirectos = new MpdfEstadosFGparche();
    ...
    //         for ($z = 0; $z < $Mes; $z++)
    //         {
    //             $oactualventas = new MpdfEstadosFGparche();
    ...
    //     $ocostodeptoventa = new MpdfEstadosFGparche();
    ...
    //         for ($z = 0; $z < $Mes; $z++)
    //         {
    //             $oactualoperaciones = new MpdfEstadosFGparche();
    ...
    //             $oestadofupdate = new MpdfEstadosFGparche();
    ...
    //     //** COSTO DEPTO OPERACIONES
    //     $ocostovehope = new MpdfEstadosFGparche();
    ...
    //         for ($z = 0; $z < $Mes; $z++)
    //         {
    //             $oactualcostove = new MpdfEstadosFGparche();
    ...
    //     $ocostofinanciero = new MpdfEstadosFGparche();
    ...
    //     $MontoMesCF = 0;
    //     $MontoAnioCF = 0;
    //     $oactualcostof = new MpdfEstadosFGparche();
    ...
    //             $oporcentajeoperacion=new MpdfEstadosFGparche();
    ...
    //             // $dataPDF['IdPlanFctura']= $element->IdPlanFactura;
    //             // $dataPDF['IdPorcentajeOperacion']= $oporcentajeoperacion->IdPorcentajeOperacion;
    //             // $dataPDF['Descripcion']= $element->Descripcion;
    //             // $dataPDF['AnioAnteriorMonto']= $AnoAnteriorMont;
    //             // $dataPDF['AnioActualPlan']= $PlanAnual;
    //             // $dataPDF['AnioActualPlanPorcent']= $PorcenAnio;
    //             // $dataPDF['AnioActualMonto']= $ColocarAnioActual;
    //             // $dataPDF['AnioActualPorcen']= 0;
    //             // $dataPDF['MesActualPlan']= $Plan;
    //             // $dataPDF['MesActualPlanPorcen']= $PorcenMes;
    //             // $dataPDF['MesActualMonto']= $Colocar;
    //             // $dataPDF['MesActualPorcen']=0;
    ...
    //      //!PEDF NUEVO ANDREA FIN 20/ENERO/2022
    // }
