...
class CestadosFinanGenFiltro extends REST_Controller
{
    public $RutaPdf;
    ...
    //!Costo GA
    public function getCostoGA_get(){
    ...
    //!Costo DeptoOper
    public function getDeptoOper_get(){
        if (!$this->verification->validToken($this->input->request_headers('Authorization'))) {
            return $this->set_unauthorized_response();
        }
    ...
    //!Costo Vehiculo
    public function getCostosVehiculos_get(){
        if (!$this->verification->validToken($this->input->request_headers('Authorization'))) {
            return $this->set_unauthorized_response();
        }
    ...
    //!Costos Financieros. 
    public function getCostosFinancieros_get(){
        // Valid Token
        if (!$this->verification->validToken($this->input->request_headers('Authorization'))) {
            return $this->set_unauthorized_response();
        }
