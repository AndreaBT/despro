...
class Cestadosfinancierosinfo extends REST_Controller
{
    public $RutaPdf;
        ...
        if(count($rowPlanFactura))
        {
            ...
            foreach($rowPlanFactura as $element)
            {
                ...
                $array = array(
                    ...
                    'MesActualPlanPorcen'   => number_format($PorcentajeMesPlan,2,'.',''),
        ...
        foreach($arraydatos as $element)
        {
            if($contador > 0)
            {
                ...
                if($element['MesActualMonto'] == 0 || is_numeric(($element['MesActualMonto'] * 100)/$MesActualMontoTot) == false)
                {
                    ...
                    $evalua1 = number_format((($element['MesActualMonto'] * 100) / $MesActualMontoTot),2,'.','');
