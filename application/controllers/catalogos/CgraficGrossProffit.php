...
class CgraficGrossProffit extends REST_Controller
{
    public function __construct()
    {
        parent::__construct();
        $this->load->model('MgraficGrossProffit');
    ...
    public function graficaGross_get()
    {
        ...
        //$value2  = $this->getDataTodos($Mes);
        //$value3  = $this->getDataTodos($Anio,$element,$IdSucursal);
        ...
        //var_dump ($value);
        foreach($Meses as $element){
            $value3  = $this->getDataTodos($Anio,$element,$IdSucursal);
            switch ($element) {
                case '0':
                    $ArrPlan[]    =$value3['np7'];
                    $ArrCurrent[] =$value3['np9'];
                    break;
                case '1':
                    $ArrPlan[]    =$value3['np7'];
                    $ArrCurrent[] =$value3['np9'];
    ...
    public function getDataTodos($anio = '',$mes = 0,$idsuc = 0)
    {
        $arraydatos = array();
        $IdSucursal = $idsuc;
        ...
        $oplanfactura = new MgraficGrossProffit();
        ...
        for ($i = 1; $i < 6; $i++)
        {
            $oservicio = new MgraficGrossProffit();
        ...
        for ($i = 1; $i < 6; $i++) {
            $oestadofinanciero = new MgraficGrossProffit();
        ...
        for ($i = 1; $i < 6; $i++) {
            ...
            foreach ($rowPlanFactura as $element) {
                ...
                $odetalleestadofinanciero = new MgraficGrossProffit();
        ...
        $ocostoga = new MgraficGrossProffit();
        $ocostoga->Anio = $Anio;
        ...
        if(count($rowcostodepto) > 0)
        {
            foreach($rowcostodepto as $element)
            {
                ...
                $MontoAnualActual = 0;
                for ($z = 0; $z < $Mes; $z++) {
                    $oactualcostoga = new MgraficGrossProffit();
        ...
        //FIN COSTOS GA
        $ogastosdirectos = new MgraficGrossProffit();
        ...
        foreach ($row as $element) {
            ...
            $oactualventas = new MgraficGrossProffit();
        ...
        $ocostodeptoventa = new MgraficGrossProffit();
        ...
        foreach ($rowcostodepto as $element) {
            ...
            for ($z = 0; $z < $Mes; $z++) {
                ...
                $oactualoperaciones = new MgraficGrossProffit();
            ...
            $oactualoperaciones->Anio = $Anio;
            $recoveryoactualoperaciones = $oactualoperaciones->get_recobery_actualoperaciones();
			//print_r($recoveryoactualoperaciones);
        ...
        if ($IdCliente == 0 && $IdClienteS == 0) {
            ...
            for ($i = 1; $i < 6; $i++) {
                ...
                $oestadofupdate = new MgraficGrossProffit();
        ...
        $ocostovehope = new MgraficGrossProffit();
        ...
        foreach ($rowcostove as $element)
        {
            ...
            for ($z = 0; $z < $Mes; $z++) {
                ...
                $oactualcostove = new MgraficGrossProffit();
        ...
        $ocostofinanciero = new MgraficGrossProffit();
        ...
        $MontoMesCF = 0;
        $MontoAnioCF = 0;
        $oactualcostof = new MgraficGrossProffit();
        ...
        if(count($rowPlanFactura))
        {
            ...
            foreach($rowPlanFactura as $element)
            {
                ...
                $oporcentajeoperacion=new MgraficGrossProffit();
