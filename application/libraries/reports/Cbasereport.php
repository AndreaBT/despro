...
class Cbasereport extends TCPDF {
	...
	//!para finanzas-Actualizar facturación de servicios

	function HeaderDetalleF2finanzas($Titulo)
	{
		$y = $this->GetY() + 4;
		$x = 10;

		$array = array(['texto' => '', 'w' => 55], ['texto' => 'MES ACTUAL', 'w' => 90, 'a' => 'C']);
		$this->SetFillColor(82, 134, 223);
		$this->SetTextColor(0, 0, 0);
		$hh = 5;
		$b = 0;
	...
	function FinanzasActualizacionCostos($Titulo)
	{
		$y = $this->GetY() + 4;
		$x = 15;

		$array = array(['texto' => '', 'w' => 55], /*['texto' => 'AÑO PASADO', 'w' => 45, 'a' => 'C'], ['texto' => 'AÑO ACTUAL', 'w' => 90, 'a' => 'C'],*/ ['texto' => 'MES ACTUAL', 'w' => 80, 'a' => 'C'], ['texto' => 'SEMANAS', 'w' => 130, 'a' => 'C']);
		$this->SetFillColor(82, 134, 223);
		$this->SetTextColor(0, 0, 0);
		$hh = 5;
		$b = 0;
		...
		//MES ACTUAL
		$this->SetFillColor(67, 160, 71);
		//$this->SetFillColor(66, 165, 245); //Color Antiguo
		$array = array(['texto' => 'Plan', 'w' => 35]);
		$this->HeaderDetalleG($array, $x + 60, $y, $hh, $b, true, 'C');
		$array = array(['texto' => 'Actual', 'w' => 35]);
		$this->HeaderDetalleG($array, $x + 95, $y, $hh, $b, true, 'C');

		//SEMANAS
		$this->SetFillColor(66, 165, 245);
		//$this->SetFillColor(66, 165, 245); //Color Antiguo
		$array = array(['texto' => 'Semana Uno', 'w' => 35]);
		$this->HeaderDetalleG($array, $x + 130, $y, $hh, $b, true, 'C');
		$array = array(['texto' => 'Semana Dos', 'w' => 35]);
		$this->HeaderDetalleG($array, $x + 165, $y, $hh, $b, true, 'C');
		$array = array(['texto' => 'Semana Tres', 'w' => 35]);
		$this->HeaderDetalleG($array, $x + 200, $y, $hh, $b, true, 'C');
		$array = array(['texto' => 'Semana Cuatro', 'w' => 35]);
		$this->HeaderDetalleG($array, $x + 235, $y, $hh, $b, true, 'C');
	}
    //!formato para estados financieros general
    function HeaderDetalleF2inGen($Titulo){
        $y=$this->GetY()+4;
        $x=10;
        ...
        $this->SetTextColor(255,255,255);
        $array=array(['texto'=>'Actual ','w'=>35]);
        $this->HeaderDetalleG($array,$x+45,$y,$hh,$b,true,'C');

        $array=array(['texto'=>'% ','w'=>25]);
        $this->HeaderDetalleG($array,$x+75,$y,$hh,$b,true,'C');

        $this->SetFillColor(67,160,71);
        $array=array(['texto'=>'Plan','w'=>35]);
        $this->HeaderDetalleG($array,$x+90,$y,$hh,$b,true,'C');
        $array=array(['texto'=>'% ','w'=>25]);
        $this->HeaderDetalleG($array,$x+120,$y,$hh,$b,true,'C');
        $array=array(['texto'=>'Actual','w'=>35]);
        $this->HeaderDetalleG($array,$x+135,$y,$hh,$b,true,'C');
        $array=array(['texto'=>'% ','w'=>25]);
        $this->HeaderDetalleG($array,$x+165,$y,$hh,$b,true,'C');
        ...
        $this->SetFillColor(66,165,245);
        $array=array(['texto'=>'Plan','w'=>35]);
        $this->HeaderDetalleG($array,$x+180,$y,$hh,$b,true,'C');
        $array=array(['texto'=>'% ','w'=>25]);
        $this->HeaderDetalleG($array,$x+210,$y,$hh,$b,true,'C');
        $array=array(['texto'=>'Actual','w'=>35]);
        $this->HeaderDetalleG($array,$x+225,$y,$hh,$b,true,'C');
        $array=array(['texto'=>'% ','w'=>25]);
        $this->HeaderDetalleG($array,$x+255,$y,$hh,$b,true,'C');
    }

    function HeaderSueldos($Titulo){
        $y = $this->GetY() + 4;
		$x = 8;

		$array = array(['texto' => '', 'w' => 55],  ['texto' => 'Sueldo Personal Manual', 'w' => 80, 'a' => 'C']);
		$this->SetFillColor(82, 134, 223);
		$this->SetTextColor(0, 0, 0);
		$hh = 5;
		$b = 0;
        ...
        $this->SetTextColor(0,0,0);
        $array=array(['texto'=>'Personal','w'=>35]);
        $this->HeaderDetalleG($array,$x,$y,$hh,$b,true,'C');

        $this->SetFillColor(33,187,160);
        $this->SetTextColor(255,255,255);
        $array=array(['texto'=>'Sueldo Base','w'=>35]);
        $this->HeaderDetalleG($array,$x+35,$y,$hh,$b,true,'C');

        $this->SetFillColor(28,140,120);
        $array=array(['texto'=>'Obligaciones(Ley)','w'=>38]);
        $this->HeaderDetalleG($array,$x+70,$y,$hh,$b,true,'C');

        $this->SetFillColor(34,181,115);
        $array=array(['texto'=>'Prestaciones','w'=>30]);
        $this->HeaderDetalleG($array,$x+108,$y,$hh,$b,true,'C');

        $this->SetFillColor(34,181,115);
        $array=array(['texto'=>'Comisiones y Bonos','w'=>41]);
        $this->HeaderDetalleG($array,$x+138,$y,$hh,$b,true,'C');

        $this->SetFillColor(51,153,204);
        $array=array(['texto'=>'Horas Extras','w'=>30]);
        $this->HeaderDetalleG($array,$x+179,$y,$hh,$b,true,'C');

        $this->SetFillColor(51,153,204);
        $array=array(['texto'=>'Descuento','w'=>30]);
        $this->HeaderDetalleG($array,$x+209,$y,$hh,$b,true,'C');

        $this->SetFillColor(51,153,204);
        $array=array(['texto'=>'Total Integrado','w'=>41]);
        $this->HeaderDetalleG($array,$x+239,$y,$hh,$b,true,'C');

    }

    function HeaderProveedor($Titulo){
        $y = $this->GetY() + 4;
		$x = 8;

		$array = array(['texto' => '', 'w' => 55],  ['texto' => 'Sueldo Personal Cuentas por Pagar', 'w' => 80, 'a' => 'C']);
		$this->SetFillColor(82, 134, 223);
		$this->SetTextColor(0, 0, 0);
		$hh = 5;
		$b = 0;
