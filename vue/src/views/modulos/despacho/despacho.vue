<template>
	<div class="mt-2">
				...
				<nav class="navbar navbar-breadcrumb navbar-expand-md bg-breadcrumb breadcrumb-borde">
					...
					<form class="form-inline d-none d-md-none d-lg-block">
						<div class="form-group mt-n1">
							<router-link class="btn btn-01 mr-1" to="/listservicio"
							...
							<button
								...
								:disabled="this.Finalizados.length == 0"
								data-backdrop="static"
								class="btn btn-02 color-01 mr-2"
							>
								Terminados
                        ...
                        Localización
							...
							<div class="dropdown mr-2">
								<button
									class="btn btn-02 color-01 btn-07 dropdown-toggle"
									type="button"
								...
								<div
									class="dropdown-menu dropdown-menu-button dropdown-menu-right"
									...
									<tr>
										...
										>
											...
											<section v-if="item.class != ''">
												...
												<input
													style="max-width:0;max-height:0;line-height:0;border:0;position:absolute;"
													id="timefocus"
													type="text"
													ref="timefocus"
												/>
								...
								<tbody>
									<tr v-for="(item2, index2) in ListaServicios" :key="index2">
										<td :class="Busqueda == item2.IdTra ? 'bg-info' : ''">
											...
											<i :style="item2.message > 0 ? 'color:green' : 'color:#0f3f87'" class="far fa-comment-dots icon-gant"
			...
			<template v-slot:="{ hide }">
				<div class="modal-content">
					...
					<div id="cuerpo" class="modal-body">
						<p
							v-for="(item, index) in ListaChat"
							:key="index"
							:class="Chat.IdContacto != item.IdUsuario ? 'globo-res' : 'globo'"
						>
							{{ item.Mensaje }}<br />
		...
		<Modal
			:NameModal="'ModalForm4'"
			:Showbutton="false"
			:size="'modal-bg'"
			:Nombre="'Servicios Finalizados'"
		>
			<template slot="Form">
