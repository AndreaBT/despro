...
export default {
	...
	methods: {
		...
		get_Lista1() {
			this.Disabled = true;
			this.$http
				.get("costodeptooper/get", {
					params: { Anio: this.Anio, Tipo: 1 }
				})
				.then(res => {
					this.Lista = res.data.data.lista;
					this.Disabled = false;
					this.ObjBurden.NumTrab = res.data.data2.NumTrabajadores;
					this.ObjBurden.SemProd = res.data.data2.SemanasPro;
					this.ObjBurden.HorasSemProd = res.data.data2.HorasSemanalesPro;
					this.ObjBurden.BurdenRate = res.data.data2.BurdenRate;
					this.ObjBurden.BurdenRateC = res.data.data2.BurdenRateCorregido;
				});
		},
