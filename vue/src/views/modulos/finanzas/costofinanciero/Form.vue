    ...
    <div class="row justify-content-start mt-3">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
            <div class="card card-01">
                <div class="row">
                    <div class="col-md-12 col-lg-12">
                        <form class="form-inline justify-content-center">
                            ...
                            <select :disabled="Disabled" @change="get_Lista1(),get_Lista2()"  v-model="Anio" class="form-control mr-2">
                ...
                <!--Fin filtros-->
                <Tabla :Lista="Lista" :Nombre="'Total Intereses y Gastos'" ></Tabla>
                <Tabla :Lista="Lista2" :Nombre="'TOTAL OTROS INGRESOS/GASTOS'" ></Tabla>
            </div>
        </div>
    </div>
</div>
         ...
         get_Lista1(){      
          ...
          this.Disabled=true;              
             this.$http.get(
                'costofinanciero/get',
                {
                    params:{ Anio:this.Anio,Tipo:2}
                }
            ).then( (res) => {
                this.Disabled=false;   
              this.Lista2=res.data.data.lista;    
        ...
        Guardar()
       {
            ...
            { 
                 ...
                 if ( this.Validar()==0)
                {
                 this.Disabled=true;  
                this.$http.post(
                    'costofinanciero/post',
                    {Detalle:this.Lista,Anio:this.Anio,Detalle2:this.Lista2,}
                ).then( (res) => {
                     this.Disabled=false;  
       ...
       Validar()
        {
            ...
            this.Lista.forEach(element => {
                ...
                if (element.NumeroCuenta=='' || element.NumeroCuenta==0 )
                {              
